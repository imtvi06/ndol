...
*               ORBITALES. ESTE ES EL VALOR IMPLICITO.
...
*               EL VALOR IMPLICITO DE IOPT(3) ES -1.
...
C Lectura de entradas sucesivas y salida de fichero MMH
...
* EVALUACION DEL LIMITE DE CONVERGENCIA COMO CONVLIM. EL VALOR
* POR OMISION ES .00001 EV

      IF (IOPT(15).EQ.0 .or. CONVLIM.eq.CERO) CONVLIM = .00001D0
*	  IF (QOCC) CONVLIM = CONVLIM*0.1D0
91    WRITE (IW,1016) CONVLIM
      CONVLIM = CONVLIM*AUEV
